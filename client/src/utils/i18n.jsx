...
const dict = {
  en: {
    ...
    'landing.footer': 'made by TypeThe0ry',
    ...
    'auth.usernamePlaceholder': '3–20 letters / digits / Chinese',
    ...
    'auth.errLengthUser': 'Username must be 3–20 characters',
    'auth.errChars': 'Only letters, digits, Chinese, _ and - allowed',
    'auth.errLengthPwd': 'Password must be at least 6 characters',
    'auth.errFailed': 'Authentication failed',

    'landing.duel': '1v1 Duel',
    'landing.loginCta': 'Log in for 1v1',

    'duel.title': '1v1 Duel',
    'duel.requireLogin': 'Log in to challenge a friend.',
    'duel.create': 'Create Room',
    'duel.creating': 'Creating…',
    'duel.join': 'Join with Code',
    'duel.joining': 'Joining…',
    'duel.codePlaceholder': 'Room code',
    'duel.invalidCode': 'Code must be 4–12 letters/digits',
    'duel.codeLabel': 'Room code',
    'duel.share':
      'Share this code with your opponent. Each of you plays one 20s round.',
    'duel.you': 'You',
    'duel.opponent': 'Opponent',
    'duel.waitingOpponent': 'Waiting for opponent to join…',
    'duel.waitingOpponentScore': 'Waiting for opponent to play…',
    'duel.yourTurn': 'Your turn — play your round!',
    'duel.played': 'Played',
    'duel.notPlayed': 'Not yet',
    'duel.playRound': 'Play My Round',
    'duel.refresh': 'Refresh',
    'duel.leave': 'Back to Home',
    'duel.winYou': 'You win! 🎉',
    'duel.winOpponent': 'Opponent wins.',
    'duel.tie': "It's a tie.",
    'duel.statusPending': 'Waiting',
    'duel.statusPlaying': 'In progress',
    'duel.statusDone': 'Finished',
    'duel.notFound': 'Duel not found',
    'duel.alreadyPlayed': 'You already submitted your score.',
    'duel.errSubmit': 'Failed to submit duel score',
  },
  zh: {
    'common.back': '← 返回',
    'common.loading': '加载中…',
    ...
    'auth.username': '用户名',
    'auth.password': '密码',
    'auth.usernamePlaceholder': '3–20 位字母/数字/中文',
    ...
    'auth.errLengthUser': '用户名需为 3–20 个字符',
    'auth.errChars': '仅支持字母、数字、中文、_ 和 -',
    'auth.errLengthPwd': '密码至少 6 位',
    'auth.errFailed': '验证失败',

    'landing.duel': '1v1 单挑',
    'landing.loginCta': '登录后单挑',

    'duel.title': '1v1 单挑',
    'duel.requireLogin': '登录后才能与好友单挑。',
    'duel.create': '创建房间',
    'duel.creating': '创建中…',
    'duel.join': '用房间码加入',
    'duel.joining': '加入中…',
    'duel.codePlaceholder': '房间码',
    'duel.invalidCode': '房间码需为 4–12 位字母或数字',
    'duel.codeLabel': '房间码',
    'duel.share': '把这个房间码发给对手,你们各打一局 20 秒。',
    'duel.you': '你',
    'duel.opponent': '对手',
    'duel.waitingOpponent': '等待对手加入…',
    'duel.waitingOpponentScore': '等待对手完成挑战…',
    'duel.yourTurn': '轮到你了 — 开始挑战!',
    'duel.played': '已完成',
    'duel.notPlayed': '未开始',
    'duel.playRound': '开始我的回合',
    'duel.refresh': '刷新',
    'duel.leave': '回到首页',
    'duel.winYou': '你赢了! 🎉',
    'duel.winOpponent': '对手获胜。',
    'duel.tie': '平局。',
    'duel.statusPending': '等待中',
    'duel.statusPlaying': '进行中',
    'duel.statusDone': '已结束',
    'duel.notFound': '房间不存在',
    'duel.alreadyPlayed': '你已经提交过分数。',
    'duel.errSubmit': '提交对战分数失败',
  },
};
